...
<tiles:insertAttribute name="footer"></tiles:insertAttribute>
 ...
 <!-- jquery library -->
        ...
        <!-- rev slider -->
        <script src="<%=request.getContextPath()%>/resources/js/rev-slider/jquery.themepunch.plugins.min.js"></script>
        <script src="<%=request.getContextPath()%>/resources/js/rev-slider/jquery.themepunch.revolution.min.js"></script>
        <script src="<%=request.getContextPath()%>/resources/js/rev-slider/rs.home.js"></script>
