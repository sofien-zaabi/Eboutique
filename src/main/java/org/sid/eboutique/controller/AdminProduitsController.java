...
import org.sid.eboutique.mitier.IAdminProduitMetier;
...
public class AdminProduitsController {
	...
	public String enregistrer(@Valid Produit p, BindingResult bindingResult, MultipartFile file, Model model) throws Exception{ 
